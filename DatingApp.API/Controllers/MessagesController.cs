...
namespace DatingApp.API.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetMessagesForUser(int userId, [FromQuery]MessageParams messageParams)
        {
            ...
            var messages = _mapper.Map<IEnumerable<MessageToReturnDto>>(messageFromRepository);

            Response.AddPagination(messageFromRepository.CurrentPage, messageFromRepository.PageSize, 
                messageFromRepository.TotalCount, messageFromRepository.TotalPages);
